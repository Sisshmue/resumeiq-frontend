        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-lg text-slate-600">
              Upload your resume and let our AI evaluate your professional
              standing.
            </p>
          </div>
          ...
          {analysis && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col items-center justify-center">
                <h3 className="text-slate-500 font-medium mb-2 uppercase tracking-wider text-sm">
                  ATS Score
                </h3>
                ...
                <p className="mt-4 text-slate-500 text-center text-sm">
                  Your resume is{" "}
                  {analysis.analysis.ATS_score > 70
                    ? "well-optimized"
                    : "needs some work"}{" "}
              ...
              <div className="grid grid-cols-1 gap-4">
                <ScoreBadge
                  label="Skill Score"
                  score={analysis.analysis.skill_score}
                  color="bg-indigo-600"
                />
                <ScoreBadge
                  label="Experience Score"
                  score={analysis.analysis.experience_score}
                  color="bg-purple-600"
                />
